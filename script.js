...
let news = [
    ...
    { title: "Hasil Pencalonan", date: "Senin, 18 Nov 2024 <br> 11:00 WIB", img: "anggota2.jpg", link: "hasil-pencalonan-news.html" }
];
...
window.addEventListener("scroll", function () {
    ...
    if (window.scrollY > 50) {
        navbar.classList.add("scrolled"); // Tambahkan class saat scroll lebih dari 50px
    } else {
